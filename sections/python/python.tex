...
The \texttt{\_\_init\_\_()} method is an initializer function which is called after a new instance is created of that class.
...
\subsection{Decorators}\label{python:decorators}
...
When using the above import statement the whole module gets imported and creates a reference to that module in the current namespace.
