...
The lattice is deduced from a sub program of the general example program on \cref{theory:general_code_example}.
The sub program can be seen on \cref{theory:general_code_example_small}.
