...
Six open source projects were tested with \pyt{} a table with results can be seen on \cref{evaluation:real:table}.
...
As one can see on the table no vulnerabilities were found and one project where \pyt{} did not terminate.
This shows that \pyt{} can be used for real projects.

\paragraph{Flaskbb}
Flaskbb did not terminate this is due to the amount of nodes being 432855 in the main control flow graph.
The amount of nodes means that the analysis takes up much time and space.
