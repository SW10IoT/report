...
\end{itemize}
\textbf{Note:} On \cref{test:ast:if_and_else} and \cref{test:ast:if_elif_else}, \textit{expr} is an expression, see \cref{}\todo{ref to python expressions}, \textit{stmt*} is a list of statements, see \cref{}\todo{ref to python statements}.
