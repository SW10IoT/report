...
The \texttt{self} keyword referinces instance variables and instance methods.
...
Python contain a number of built in collection classes used to store items in a structured way.
