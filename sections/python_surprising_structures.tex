...
To illustrate the different approaches the following two methods are used, \cref{parameter_passing:reassign} and \cref{parameter_passing:reassign}.

\begin{lstlisting}[style=python, caption={Parameter passing: \texttt{reassign} method.}, label={parameter_passing:reassign}]
  def reassign(l):
      l = [1]
\end{lstlisting}

\begin{lstlisting}[style=python, caption={Parameter passing: \texttt{append} method.}, label={parameter_passing:append}]
  def append(l):
      l.append(1)
\end{lstlisting}
