...
\subsection{Pass By Object Reference}
Should contain:
\begin{itemize}
\item \url{http://robertheaton.com/2014/02/09/pythons-pass-by-object-reference-as-explained-by-philip-k-dick/}
  Ovenstående bare mere concise if possible
\item evt kig på:
\url{http://stackoverflow.com/a/986145}
\end{itemize}
